...
- `build-master`
    ...
    - configure redmine-repository `uri` to change ssh link to your respository.
    - configure redmine-repository `branch` to change building branch of your respository.
